  ...
  render() {
    ...
    if (!wisdm_ld_reports_common_script_data.is_pro_version_active) {
      body = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_commons_dummy_reports_index_js__WEBPACK_IMPORTED_MODULE_7__["default"], {
        image_path: "iu.jpg",
        url: "https://wisdmlabs.com/reports-for-learndash/?utm_source=wrld&utm_medium=reports_dashboard&utm_campaign=Learner-activity-reports&utm_term=inactive-user-list#pricing"
      });
      // body = '';
      return body;
    }
