...
class LearnerActivityLog extends react__WEBPACK_IMPORTED_MODULE_7__.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      lock_icon: '',
      request_data: null,
      help_text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('This report displays the learner activity log on the website.', 'learndash-reports-by-wisdmlabs'),
  ...
  render() {
    ...
    if (!wisdm_ld_reports_common_script_data.is_pro_version_active) {
      body = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_commons_dummy_reports_index_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        image_path: "lal.png",
        url: "https://wisdmlabs.com/reports-for-learndash/?utm_source=wrld&utm_medium=reports_dashboard&utm_campaign=Learner-activity-reports&utm_term=learner-activity-log#pricing"
      });
      // body = '';
      return body;
    }
