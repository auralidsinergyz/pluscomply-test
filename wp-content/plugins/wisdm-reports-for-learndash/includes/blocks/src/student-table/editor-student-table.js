...
registerBlockType( 'wisdm-learndash-reports/student-table', {
    ...
    title: __( 'Student Table', 'learndash-reports-by-wisdmlabs' ),
    description: __( 'Student Table', 'learndash-reports-by-wisdmlabs' ),
        ...
        save ( ) {
            return (
                <div { ...useBlockProps.save() }>
                    <div class="wisdm-learndash-reports-student-table front">
