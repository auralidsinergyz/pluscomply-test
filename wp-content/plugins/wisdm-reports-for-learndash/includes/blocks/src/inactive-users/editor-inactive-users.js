...
registerBlockType( 'wisdm-learndash-reports/inactive-users', {
    ...
    title: __( 'Inactive Users', 'learndash-reports-by-wisdmlabs' ),
    description: __( 'Report of the Inactive Users', 'learndash-reports-by-wisdmlabs' ),
        ...
        save ( ) {
            return (
                <div { ...useBlockProps.save() }>
                    <div class="wisdm-learndash-reports-inactive-users front">
