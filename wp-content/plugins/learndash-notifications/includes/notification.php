...
function learndash_notifications_get_object_fields(): array {
	...
	return apply_filters( 'learndash_notifications_object_fields', array(
		'group_id'          => array(
			...
			'value'           => array(
				'all'            => sprintf( _x( 'Any %s', 'Group label', 'learndash-notifications' ), $group_label ),
			),
			'dynamic_options' => 1,
			'trigger_object'  => 1,
			'multiple'		  => 1,
		...
		'course_id'         => array(
			...
			'value'           => array(
				'all'            => sprintf( _x( 'Any %s', 'Course label', 'learndash-notifications' ), $course_label ),
			),
			'dynamic_options' => 1,
			'trigger_object'  => 1,
			'multiple'		  => 1,
		...
		'lesson_id'         => array(
			...
			'value'           => array(
				'all'            => sprintf( _x( 'Any %s', 'Lesson label', 'learndash-notifications' ), $lesson_label ),
			),
			'dynamic_options' => 1,
			'disabled_child'  => 1,
			'trigger_object'  => 1,
		...
		'topic_id'          => array(
			...
			'value'           => array(
				'all'            => sprintf( _x( 'Any %s', 'Topic label', 'learndash-notifications' ), $topic_label ),
			),
			'dynamic_options' => 1,
			'disabled_child'  => 1,
			'trigger_object'  => 1,
		...
		'quiz_id'           => array(
			...
			'value'           => array(
				'all'            => sprintf( _x( 'Any %s', 'Quiz label', 'learndash-notifications' ), $quiz_label ),
			),
			'dynamic_options' => 1,
			'disabled_child'  => 1,
			'trigger_object'  => 1,
