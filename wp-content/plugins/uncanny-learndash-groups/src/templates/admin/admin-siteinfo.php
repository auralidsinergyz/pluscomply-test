...
function uo_get_server_database_version() {
	...
	if ( $db_server_info['mysqldb_active'] ) {
		...
		$db_type         = __( 'MySQL Version', 'uncanny-learndash-groups' );
	...
	} elseif ( $db_server_info['mariadb_active'] ) {
		$db_type         = __( 'MariaDB Version', 'uncanny-learndash-groups' );
		$db_version      = $db_server_info['db_version_found'];
...
$min_requirements = ' <a href="https://wordpress.org/about/requirements/" target="_blank">' . __( 'WordPress Minimum Requirements', 'uncanny-learndash-groups' ) . '</a>';
...
$table_enviroment = (object) array(
		'title'   => __( 'Environment', 'uncanny-learndash-groups' ),
		'heading' => array(
				__( 'Setting', 'uncanny-learndash-groups' ),
				__( 'Value', 'uncanny-learndash-groups' ),
		),
		'rows'    => array(),
);

$table_enviroment->rows[] = array(
		__( 'Server info', 'uncanny-learndash-groups' ),
...
//if ( defined( 'PHP_OS' ) ) {
//	$php_version .= __( ' PHP_OS: ', 'uncanny-learndash-groups' ) . PHP_OS;
//}
//
//if ( defined( 'PHP_OS_FAMILY' ) ) {
//	$php_version .= __( ' PHP_OS_FAMILY: ', 'uncanny-learndash-groups' ) . PHP_OS_FAMILY;
//}
...
$table_enviroment->rows[] = array(
		__( 'PHP Version', 'uncanny-learndash-groups' ),
		$php_version,
);
...
$table_wordpress_settings = (object) array(
		'title'   => __( 'WordPress Settings', 'uncanny-learndash-groups' ),
		'heading' => array(
				__( 'Setting', 'uncanny-learndash-groups' ),
				__( 'Value', 'uncanny-learndash-groups' ),
		),
...
$table_wordpress_settings->rows[] = array(
		__( 'WordPress address (URL)', 'uncanny-learndash-groups' ),
		get_option( 'home' ),
);
$table_wordpress_settings->rows[] = array(
		__( 'Site address', 'uncanny-learndash-groups' ),
		get_option( 'siteurl' ),
);

// WordPress version
$table_wordpress_settings->rows[] = array(
		__( 'WordPress Version', 'uncanny-learndash-groups' ),
		$wp_version,
);

// Multisite
$table_wordpress_settings->rows[] = array(
		__( 'Multisite', 'uncanny-learndash-groups' ),
		is_multisite() ? __( 'Yes', 'uncanny-learndash-groups' ) : __( 'No', 'uncanny-learndash-groups' ),
);

// Language
$table_wordpress_settings->rows[] = array(
		__( 'Site Language', 'uncanny-learndash-groups' ),
		get_locale(),
);
...
foreach ( $wp_constants as $wp_constant ) {
	$table_wordpress_settings->rows[] = array(
			$wp_constant,
			defined( $wp_constant ) ? constant( $wp_constant ) : __( 'Not defined', 'uncanny-learndash-groups' ),
	);
}

// Object Cache
$table_wordpress_settings->rows[] = array(
		__( 'Object Cache', 'uncanny-learndash-groups' ),
		wp_using_ext_object_cache() ? __( 'Yes', 'uncanny-learndash-groups' ) : __( 'No', 'uncanny-learndash-groups' ),
);
...
$table_wordpress_plugins = (object) array(
		'title'   => __( 'Active WordPress Plugins', 'uncanny-learndash-groups' ),
		'heading' => array(
				__( 'Plugin', 'uncanny-learndash-groups' ),
				__( 'Version', 'uncanny-learndash-groups' ),
		),
		'rows'    => array(),
);
...
$tables[] = (object) array(
		'title'   => __( 'LearnDash Settings', 'uncanny-learndash-groups' ),
		'heading' => array(
				__( 'Setting', 'uncanny-learndash-groups' ),
				__( 'Value', 'uncanny-learndash-groups' ),
		),
		'rows'    => array(
				array(
						__( 'Version', 'uncanny-learndash-groups' ),
						defined( 'LEARNDASH_VERSION' ) ? LEARNDASH_VERSION : __( 'LearnDash not active', 'uncanny-learndash-groups' ),
				),
				array(
						__( 'DB Version', 'uncanny-learndash-groups' ),
						defined( 'LEARNDASH_SETTINGS_DB_VERSION' ) ? LEARNDASH_SETTINGS_DB_VERSION : __( 'LearnDash not active', 'uncanny-learndash-groups' ),
				),
				array(
						__( 'Script Debug', 'uncanny-learndash-groups' ),
						( defined( 'LEARNDASH_SCRIPT_DEBUG' ) ) ? LEARNDASH_SCRIPT_DEBUG : __( 'not defined', 'uncanny-learndash-groups' ),
				),
		),
);
...
$table_php_settings = (object) array(
		'title'   => __( 'PHP Settings', 'uncanny-learndash-groups' ),
		'heading' => array(
				__( 'Setting', 'uncanny-learndash-groups' ),
				__( 'Value', 'uncanny-learndash-groups' ),
		),
