 ...
 */
class Code_GF_Field extends GF_Field {

	/**
	 * @var string $type The field type.
	 */
	public $type = 'ulgm_code';
	...
	public function get_form_editor_field_title() {
		return esc_attr__( 'Uncanny Key', 'uncanny-learndash-groups' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( "Redeem Uncanny Group's seat code during registration", 'uncanny-learndash-groups' );
	}
	...
	public function get_form_editor_inline_script_on_page_render() {
		...
		// set the default field label for the ulgm_code type field
		$script = sprintf( "function SetDefaultValues_ulgm_code(field) {field.label = '%s';}", $this->get_form_editor_field_title() ) . PHP_EOL;
...
GF_Fields::register( new Code_GF_Field() );
