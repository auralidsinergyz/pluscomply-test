...
$tabs = [
	(object) [
		...
		'name' => __( 'Generate Codes', 'uncanny-learndash-codes' )
	],
	(object) [
		'id'   => 'uncanny-learndash-codes-view',
		'href' => menu_page_url( 'uncanny-learndash-codes-view', false ),
		'name' => __( 'View Codes', 'uncanny-learndash-codes' )
	],
	(object) [
		'id'   => 'uncanny-learndash-codes-settings',
		'href' => menu_page_url( 'uncanny-learndash-codes-settings', false ),
		'name' => __( 'Settings', 'uncanny-learndash-codes' )
	],
	(object) [
		'id'   => 'uncanny-codes-kb',
		'href' => menu_page_url( 'uncanny-codes-kb', false ),
		'name' => __( 'Help', 'uncanny-learndash-codes' )
	],
	(object) [
		'id'   => 'uncanny-codes-plugins',
		'href' => menu_page_url( 'uncanny-codes-plugins', false ),
		'name' => __( 'LearnDash Plugins', 'uncanny-learndash-codes' )
	],
	(object) [
		'id'   => 'uncanny-codes-license-activation',
		'href' => menu_page_url( 'uncanny-codes-license-activation', false ),
		'name' => __( 'License Activation', 'uncanny-codes-license-activation' )
	],
];
...
<div class="ulc-header">
	<div class="ulc-header-top">
		<div class="ulc-header-top__title">
			<?php _e( 'Uncanny LearnDash Codes', 'uncanny-learndash-codes' ); ?>
		</div>
		<div class="ulc-header-top__author">
			<span><?php _e( 'by', 'uncanny-learndash-codes' ); ?></span>
			<a href="https://uncannyowl.com" target="_blank" class="ulc-header-top__logo">
