...
if ( ! class_exists( '\LDMC\Admin\Settings\Group' ) ) {
    class Group {
        ...
        function multiselect_group_certificate( $setting_option_fields, $settings_metabox_key )
        {
            ...
            if ( $this->settings_metabox_key == $settings_metabox_key
                ...
                // translators: placeholder: course.
                    esc_html_x( 'The %s Multiple Certificates feature is enabled, so now you can select multiple certificates from the drop-down and studnets will be able to select their desired certificate from the frontend popup.', 'placeholder: group', LD_MC_TEXT_DOMAIN ),
