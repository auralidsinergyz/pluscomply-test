					...
					<div id="post-body" class="metabox-holder columns-2">
						<div id="postbox-container-1" class="postbox-container">
							<div id="submitdiv" class="postbox ">
								<h2 class="postbox-header"><span><?php _e('Publish', 'archive-control'); ?></span></h2>
								<div class="inside">
							...
							<?php if ($image_val == 'enabled') : ?>
								<div id="featured-image-archive" class="postbox ">
									<h2 class="postbox-header"><span><?php _e('Archive Featured Image', 'archive-control'); ?></span></h2>
									<div class="inside">
										<?php
										$upload_link = esc_url( get_upload_iframe_src( 'image' ) );
							...
							<div id="postbox-container-2" class="postbox-container">
								...
								if (!empty($custom_post_types)) {
									foreach($custom_post_types as $post_type) {
										...
										?>
										<div class="postbox">
											<h2 class="postbox-header"><span><?php echo $post_type->label; ?></span></h2>
											<div class="inside">
							...
							<div id="postbox-container-2" class="postbox-container">
								...
								if (!empty($taxonomies)) {
									foreach($taxonomies as $taxonomy) {
										...
										?>
										<div class="postbox">
											<h2 class="postbox-header"><span><?php echo $taxonomy->label; ?></span></h2>
											<div class="inside">
												<table class="form-table">
