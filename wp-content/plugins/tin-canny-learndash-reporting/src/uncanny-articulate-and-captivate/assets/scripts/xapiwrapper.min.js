...
function init()
{
  ...
  ADL.XAPIWrapper.changeConfig({
    'endpoint': 'http://uncannylocal3.com/ucTinCan/'
  });
  ...
  return {
    getCache: function () {
      ...
      if (r.scorm_version != "1.2") {
        ADL.XAPIWrapper.changeConfig({isScorm2004: true});
        xapi.changeConfig("isScorm2004", true);
        xapi.changeConfig
      }
      ...
      console.log({SetValue: e, varvalue: r});
      var t = new Date;
